...
function BloomFilter.__new(items, probability)
	...
	assert(probability > 0 and probability < 1, "probability has to be between 0 and 1")

	local bits = math.ceil(items * math.log(probability) / math.log(1 / math.pow(2, math.log(2))))
